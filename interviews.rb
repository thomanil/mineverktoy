...
def interviews_config
  [{:published? => true, :published_timestamp => 1301334838, :published_at => '28.03.2011', :name => 'andre-eide', :full_name => 'André Eide', :title => 'Selvstendig næringsdrivende og fotograf'},
   ...
   {:published? => false, :published_timestamp => 1301141761, :published_at => '26.03 2011', :name => 'eli-toftoy-andersen', :full_name => 'Eli Toftøy-Andersen', :title => 'Senior rådgiver i brukervennlighet og design hos Steria'},
